...
//Protected variables are accessible in subclasses andin same package
public class AM_Protected {
    public static void main(String[] args) {

        AM_Protected_Parent a = new AM_Protected_Parent();
        a.superClassFunction();
        System.out.println("Variable is accessed in same package : "+a.age);
...
Variable is accessed in same package : 60
